  ...
  <div className={styles.WelcomePage} style={{
    ...
    <div style={{marginLeft:"80px", marginRight:"80px"}}>
      ...
      <div style={{display: "grid"}}>
        ...
        <div style={{textAlign: "right", gridColumn: "1", gridRow: "1", paddingTop: "130px", paddingRight: "5px", }}><img style={{height: "50px"}} src={picture1} alt="no picture found"/></div>
      </div>
      <div style={{display: "grid"}}>
        <div style={{
        width: "500px",
        ...
        <img style={{alignSelf: 'left', gridColumn: "1", gridRow: "1", paddingTop: "130px", paddingLeft: "5px", height: "50px"}} src={picture2} alt="no picture found"/>
        </div>
      <div style={{display: "grid"}}>
        <div style={{
        width: "500px",
        ...
        <div style={{textAlign: "right", gridColumn: "1", gridRow: "1", paddingTop: "130px", paddingRight: "5px", }}><img style={{height: "50px"}} src={picture3} alt="no picture found"/></div>
      </div>
    </div>
