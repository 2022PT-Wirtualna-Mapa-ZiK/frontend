    ...
    >
      <div style={{ marginLeft: "80px", marginRight: "80px" }}>
        ...
        <div style={{ display: "grid" }}>
          ...
          >
            Jesteśmy studentami Wydziału Informatyki Politechniki Białostockiej.
          </p>
          <div
            style={{
              textAlign: "right",
          ...
          >
            <img style={{ height: "50px" }} src={picture1} alt="not found" />
          </div>
        </div>
        <div style={{ display: "grid" }}>
          <div
          ...
          >
            Pracujemy nad projektem który pomoże znaleźć pracę dla ludzi zgodną
            z ich potrzebami
          </p>
          <img
            style={{
        ...
        <div style={{ display: "grid" }}>
          ...
          >
            Pracujemy w dwóch zespołach - backendowym oraz frontendowym, w
            każdym z nich jest około 4-6 osób
          </p>
          <div
            style={{
              textAlign: "right",
          ...
          >
            <img style={{ height: "50px" }} src={picture3} alt="not found" />
          </div>
        </div>
      </div>
